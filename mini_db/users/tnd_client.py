...
class Client(object):
    ...
    def connect(self):
        ...
        try:
            ...
            # self.ws = yield websocket_connect(tornado.httpclient.HTTPRequest(url=self.url, ca_certs=os.path.join(os.path.abspath('.'), "localhost.pem")))
...
if __name__ == '__main__':
    ...
    """
    # single
    wss_url = f"ws://127.0.0.1:80/realtime/122/222/322"
